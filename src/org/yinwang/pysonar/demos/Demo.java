...
public class Demo {
	...
	private static final String JS = $.readResource(String.format("demo%sjavascript%shighlight.js", File.separator, File.separator));
	private static final String JS_DEBUG = $.readResource(String.format("demo%sjavascript%shighlight-debug.js", File.separator, File.separator));
	...
	private void start(String fileOrDir, Map<String, Object> options) throws Exception
	{
