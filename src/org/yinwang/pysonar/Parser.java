...
public class Parser {
	...
	private <T> List<T> convertList(Object o)
	{
		if (o == null) {
			return null;
		} else {
	...
	List<Name> segmentQname(String qname, int start, boolean hasLoc)
	{
	...
	private boolean sendCommand(String cmd, Process pythonProcess)
	{
		try {
